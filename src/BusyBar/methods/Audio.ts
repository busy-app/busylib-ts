import { play as playApi, stop as stopApi, getAudioVolume as getAudioVolumeApi, setAudioVolume as setAudioVolumeApi } from 'BusyBar/api/audio';
...
export class AudioMethods {
   ...
   */
  async AudioPlay(this: BusyBar, params: AudioPlayParams, options?: RequestOptions): Promise<SuccessResponse> {
    return await playApi(this.apiClient, params, options);
  }
   ...
   */
  async AudioStop(this: BusyBar, options?: RequestOptions): Promise<SuccessResponse> {
    return await stopApi(this.apiClient, options);
  }
   ...
   */
  async AudioVolumeGet(this: BusyBar, options?: RequestOptions): Promise<AudioVolumeInfo> {
    return await getAudioVolumeApi(this.apiClient, options);
  }
   ...
   */
  async AudioVolumeSet(this: BusyBar, params: AudioVolumeParams, options?: RequestOptions): Promise<SuccessResponse> {
    return await setAudioVolumeApi(this.apiClient, params, options);
  }
}
