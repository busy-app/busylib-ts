...
export class TimeMethods {
   ...
   */
  async TimeTimezoneGet(this: BusyBar, params?: TimeoutOptions): Promise<TimezoneInfo> {
   ...
   */
  async TimeTzListGet(this: BusyBar, params?: TimeoutOptions): Promise<TimezoneList> {
