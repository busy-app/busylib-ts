import { status as statusMatterApi, pairDevice as pairDeviceMatterApi, eraseDevices as eraseDevicesMatterApi } from 'BusyBar/api/matter';
...
export class MatterMethods {
   ...
   */
  async MatterStatusGet(this: BusyBar, params?: TimeoutOptions): Promise<MatterStatus> {
   ...
   */
  async MatterPair(this: BusyBar, params?: TimeoutOptions): Promise<MatterPairingInfo> {
